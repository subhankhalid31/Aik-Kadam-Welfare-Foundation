...
import { LogIn, CheckCircle2, Clock, XCircle } from "lucide-react";
...
export default function MyDonationsPage() {
  ...
  useEffect(() => {
    if (user) {
      api.get<{ donations: DonationRow[] }>("/api/account/my-donations").then((data) => setDonations(data.donations)).finally(() => setLoading(false));
    }
  }, [user]);
