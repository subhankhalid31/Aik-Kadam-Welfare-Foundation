    ...
    return (
      <PageLayout>
        <main className="max-w-md mx-auto px-6 pt-24 pb-24 text-center">
          ...
          <a href="/login" className="glass-surface mt-8 inline-flex items-center justify-center w-full rounded-full bg-primary/65 px-7 py-3.5 font-semibold text-background hover:bg-primary-dark transition-colors">
            Sign In
          </a>
        </main>
      </PageLayout>
